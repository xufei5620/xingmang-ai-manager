export const statuses = {
  tool: { missing: ['未安装', 'neutral'], installing: ['安装中', 'accent'], configuring: ['正在配 Key', 'accent'], updating: ['更新中', 'accent'], ready: ['已配好', 'ok'], official: ['官方账号', 'ok'], unconfigured: ['还没配 Key', 'warn'], notEnabled: ['账号未开通', 'neutral'], update: ['可更新', 'warn'], keyRevoked: ['Key 失效', 'bad'], zeroBalance: ['余额为零', 'bad'], unknownSource: ['用的是别处的配置', 'neutral'], otherSiteKey: ['不是当前账号的 Key', 'warn'], otherAccountKey: ['Key 可能不是当前账号的', 'warn'], configChanged: ['配置被改过', 'warn'], ccSwitch: ['CC Switch 的设置', 'warn'], detectionFailed: ['检测失败', 'bad'], configUnavailable: ['配置暂未读到', 'warn'] },
