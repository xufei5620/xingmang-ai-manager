...
sidebarHtml = (function (previous) { return function () {
  const item = `<a class="${S.page === 'acceleration' ? 'active' : ''}" onclick="A.go('acceleration')" data-testid="nav-acceleration">${ic('globe')}<span class="lbl">全球加速</span></a>`;
