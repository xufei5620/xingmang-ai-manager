...
> 本文件 = 会话之间的**当前状态快照**，不是流水账。**时效性文档：与 AGENTS.md 或代码冲突时一律以代码为准。**
...
- **`docs/` 下多份计划文档描述的是中间态**（尤其 `ACCOUNT-PLAN.md` / `CANVAS-INTEGRATION-PLAN.md` 里 2026-08-12 之前的画布与账号描述），AGENTS.md 第 9 节已就画布文档标注「2026-08-12 起执行搬进主进程，早于该日期的描述以代码为准」。
...
2. `AGENTS.md` — 不变量 I1-I15 / 陷阱 T1-T13，**保命的**
