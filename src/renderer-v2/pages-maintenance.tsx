  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: '添加一条连接',
        detail:
          '页面顶部先选要给哪个工具添加，再点「添加连接」。填好连接名称，选「网络服务」就填服务地址，选「本地程序」就填要运行的程序名，参数按 JSON 字符串数组填。页面上「常用连接」里的浏览器、GitHub、本地文件三个按钮会把这些字段直接填好，第一次建议从它们开始。',
        action: '打开外接工具',
        page: 'mcp',
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: '添加插件',
        detail:
          '顶部选好工具后点「添加插件」，在「来源」里填插件名称或它的仓库地址，再选添加范围。Codex CLI 还多一个「市场」标签页：先「添加市场」填市场地址，之后就能从市场里挑，市场那一行还能更新或移除。其他工具只有「已安装」这一份列表。',
        action: '打开插件',
        page: 'plugins',
      },
      {
      ...
      },
      {
        title: '装完没反应怎么办',
        detail:
          '工具正在运行时装的插件不会立刻生效，先保存手头的内容，再重新打开工具。提示「当前工具未提供市场管理接口」，是这个工具没有市场，已装的插件仍然在「已安装」里。来源拿不准就先别装，插件能做的事和工具本身一样多。',
        action: '打开插件',
        page: 'plugins',
      },
    ],
