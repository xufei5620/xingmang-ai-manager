...
export type NavigationGroup = 'use' | 'extensions' | 'support' | 'more'
...
export const navigationItems: readonly NavigationItem[] = [
  ...
  { id: 'health', label: '检查', icon: HeartPulse, group: 'support', hint: '看本机环境正不正常' },
  ...
  { id: 'tutorial', label: '教程', icon: BookOpen, group: 'support', hint: '一步步教你怎么用' },
  { id: 'updates', label: '更新', icon: RefreshCw, group: 'more', hint: '升级本软件' },
  { id: 'settings', label: '设置', icon: Settings, group: 'support', hint: '改主题、工作目录和启动项' },
]
